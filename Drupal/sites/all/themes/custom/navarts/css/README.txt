...
To use these stylesheets, rename the files and navarts with the name of your theme.
...
navarts-alpha-default-narrow.css  
...
navarts-alpha-default-normal.css
...
navarts-alpha-default-wide.css
